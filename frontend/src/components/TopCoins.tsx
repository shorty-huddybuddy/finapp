...
export default function TopCoins({ data, onSelectCoin }: TopCoinsProps) {
  if (!data) {
    return (
      <Card className="bg-white border-gray-200">
        <CardHeader>
          <CardTitle className="text-gray-800">Top Coins</CardTitle>
        </CardHeader>
        <CardContent>
        ...
        {data.slice(0, 6).map((coin) => (
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium text-gray-800">{coin.symbol.toUpperCase()}</span>
            </div>
