...
export function Navbar() {
  ...
  // Use useEffect for proper dropdown initialization as in Navbar2.tsx
  useEffect(() => {
        ...
        >
          ...
          >
            ...
            >
              ...
              <div className="absolute left-0 top-full w-48 bg-white rounded-md shadow-lg py-1 hidden group-hover:block transition-all duration-200">
                <a
